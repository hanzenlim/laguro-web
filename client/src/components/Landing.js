    ...
    renderDentistVersion = () =>  {
        ...
        return (
            <div>
                ...
                <PhotoGrid data-name="dentist-photo-grid" numRow="2" page="landing" objects={dentists} header={"Popular Dentists"} />
            </div>);
    }
    ...
    renderOfficeVersion = () =>  {
        ...
        return (
            <div>
                ...
                <PhotoGrid data-name="office-photo-grid" numRow="2" objects={offices} header={"New Listings"}/>
            </div>);
    }
