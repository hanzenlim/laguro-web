    ...
    <Box width="100%" px={[6, '', 10]} mb={12}>
        ...
        >
            ...
            <Flex justifyContent="space-between" mb={6}>
                ...
                <Text fontWeight="medium" fontSize={[0, '', 1]} color="#b11f29">
                    {coverage}
                </Text>
            </Flex>
            <Box borderTop="2px solid" borderColor="divider.gray" mb={10} />

            <Box textAlign="right">
                <Text fontWeight="medium" fontSize={[0, '', 2]} is="span">
                    Out-of-pocket cost* :
                </Text>
                <Text
                    fontWeight="medium"
