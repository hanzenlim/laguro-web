...
class DentistDashboardAppointments extends PureComponent {
    renderAppointments = appointments =>
        appointments.map(
            ({
                ...
                const { lastName, firstName, imageUrl } = patient;
...
DentistDashboardAppointments.propTypes = {
...
export default DentistDashboardAppointments;
