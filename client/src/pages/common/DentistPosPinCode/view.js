        ...
        return (
            <Flex flexDirection="column" alignItems="center">
                <Flex justifyContent="center">
                    {pinArr.map((pin) => 
                        <StyledDiv justifyContent="center" alignItems="center" width={["42px", "60px", "60px"]} height={["40px", "54px", "54px"]}>{pin}</StyledDiv>
                    )}
                </Flex>
                <Text>Use this pin code to validate your POS transaction</Text>
                <Button mt="20px" onClick={onRenewPincode}>Renew pin code</Button>
            </Flex>
        )
    }
}
