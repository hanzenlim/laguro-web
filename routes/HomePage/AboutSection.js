                ...
                <Grid gridTemplateColumns={['1fr', '', '1fr 1fr']}>
                    <Box pt={[0, '', 42]} mb={[55, '', 0]}>
                        ...
                        <Text
                            ...
                            maxWidth="100%"
                        >
                            Laguro makes it simple for you to find and connect
                            with the right dentist anytime, anywhere. We are
                            here to help you simplify your dental search by
                            ensuring that you are matched with the best!
                        </Text>
                        <Link to="/about">
                            <Text
                                fontSize={[1, '', 4]}
