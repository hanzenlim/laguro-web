        ...
        return (
            <Composed {...{ userId, currentWizardStepId }}>
                {({
                    ...
                    const getProgressStep = wizardStepId => {
                        let currentStep =
                        ...
                        if (
                            ...
                            currentStep = 1;
                        } else if (wizardStepId === INSURANCE_WIZARD_STEP_ID) {
                            currentStep = 2;
                        } else if (
                            HEALTH_HISTORY_STAGE_WIZARD_STEP_IDS.includes(
                                wizardStepId
...
export default _flowRight(withScreenSizes, withRouter)(
    PatientWebOnboardingPage
);
